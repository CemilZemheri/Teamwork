...
console.log(NewObj["propertyName"])
console.log(NewObj.methodName(5))
...
class Car extends Vehicle {
    ...
    constructor(isRunning, brand, model, year, Vehicle, vehicleIsActive) {
        super(Vehicle)
...
// const Mercedes = new Car('Mercedes', 'CLK300', 2020, )
// console.log(Mercedes)
// const Mercedes = new Car(false,'Mercedes', 'CLK300', 2020, 'auto', "merhaba")
// console.log(Mercedes)
